window.EXERCISE_DATA = {
  ...
  theory: `
    ...
    <p>Sustantivos incontables comunes: <strong>water, rice, sugar, money, information, advice,
    furniture, homework, news</strong>. Estos no llevan "a/an" ni "-s" en plural.</p>
    <p>Para cuantificarlos se usan expresiones como <strong>a glass of water</strong> (un vaso de agua),
    <strong>a piece of advice</strong> (un consejo), <strong>a piece of furniture</strong> (un mueble).</p>
  `,
