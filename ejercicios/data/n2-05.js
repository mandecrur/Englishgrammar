window.EXERCISE_DATA = {
  ...
  theory: `
    ...
    <table>
      ...
      <tr><td>write</td><td>wrote</td><td>escribir → escribí</td></tr>
      <tr><td>read</td><td>read (se pronuncia distinto)</td><td>leer → leí</td></tr>
      <tr><td>give</td><td>gave</td><td>dar → di</td></tr>
      <tr><td>get</td><td>got</td><td>obtener/conseguir → obtuve</td></tr>
      <tr><td>know</td><td>knew</td><td>saber/conocer → supe</td></tr>
      <tr><td>think</td><td>thought</td><td>pensar → pensé</td></tr>
      <tr><td>say</td><td>said</td><td>decir → dije</td></tr>
      <tr><td>tell</td><td>told</td><td>contar/decir → conté</td></tr>
      <tr><td>find</td><td>found</td><td>encontrar → encontré</td></tr>
      <tr><td>buy</td><td>bought</td><td>comprar → compré</td></tr>
      <tr><td>bring</td><td>brought</td><td>traer → traje</td></tr>
      <tr><td>run</td><td>ran</td><td>correr → corrí</td></tr>
      <tr><td>speak</td><td>spoke</td><td>hablar → hablé</td></tr>
      <tr><td>drink</td><td>drank</td><td>beber → bebí</td></tr>
    </table>
    <p>Esta no es una lista completa (existen muchos más verbos irregulares en inglés), pero estos son
    los más frecuentes en el día a día. Se recomienda memorizarlos poco a poco practicando con ejemplos.</p>
