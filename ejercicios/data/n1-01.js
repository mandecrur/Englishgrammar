window.EXERCISE_DATA = {
  ...
  groups: [
    ...
    },
    {
      ...
      type: "order",
      questions: [
        { words: ["She", "is", "a", "teacher", "."], translation: "Ella es profesora.",
          explanation: "Orden correcto: sujeto + verbo + artículo + sustantivo." },
        { words: ["We", "are", "very", "happy", "."], translation: "Nosotros estamos muy felices.",
          explanation: "Orden correcto: sujeto + verbo + adverbio + adjetivo." },
        { words: ["Is", "he", "your", "friend", "?"], translation: "¿Es él tu amigo?",
          explanation: "Es una pregunta, por eso lleva '?' al final. El verbo 'is' va antes del sujeto 'he'." },
        { words: ["They", "are", "not", "tired", "."], translation: "Ellos no están cansados.",
          explanation: "La negación 'not' va justo después del verbo 'are'." },
        { words: ["I", "am", "a", "student", "."], translation: "Yo soy estudiante.",
          explanation: "Orden correcto: sujeto + verbo + artículo + sustantivo." },
        { words: ["Are", "you", "hungry", "now", "?"], translation: "¿Tienes hambre ahora?",
          explanation: "Es una pregunta, por eso lleva '?' al final. 'Are' va al inicio, antes de 'you'." },
        { words: ["It", "is", "not", "difficult", "."], translation: "No es difícil.",
